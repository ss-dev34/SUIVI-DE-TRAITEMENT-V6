...
function Ajouter(){
    ...
    if(ferme.value !== "" && parcelle.value !== ""  && superficie.value !== "" && culture.value !== "" && varietee.value !== "" && cycle.value !== "" ){
...
function Modify(){
    if(ferme_modifide.value !== "" && parcelle_modifide.value !== ""  &&  superficie_modifide.value !== "" && culture_modifide.value !== "" && varietee_modifide.value !== "" && cycle_modifide.value !== ""){
